# -*- coding: utf-8 -*-
"""
Ablation A2: Mean Pooling (no attention pooling)
Encoder is fine-tuned end-to-end.
Replace this result in Table IV row: "w/o Attention Pooling (Mean)"
"""
...
for fold, (train_idx, test_idx) in enumerate(kf.split(texts), 1):
    ...
    model = MeanPoolingRegressor(MODEL_NAME).to(device)

    training_args = TrainingArguments(
        output_dir=f"./ablation_mean_fold_{fold}",
        num_train_epochs=10,
